...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    virtual zCArchiver* CreateArchiverRead(zCBuffer* buffer, int arcFlags = 0)                                                              zCall(0x0051A020);
    virtual zCArchiver* CreateArchiverRead(zFILE* fileRead, int arcFlags = 0)                                                               zCall(0x0051A0B0);
    virtual zCArchiver* CreateArchiverRead(const zSTRING& file, int arcFlags = 0)                                                           zCall(0x0051A120);
    virtual zCArchiver* CreateArchiverWrite(zCBuffer* buffer, zTArchiveMode arcMode, zBOOL saveGame = FALSE, int arcFlags = 0)              zCall(0x0051ADB0);
    virtual zCArchiver* CreateArchiverWrite(zTArchiveMode arcMode, zBOOL saveGame = FALSE, int arcFlags = 0)                                zCall(0x0051AF00);
    virtual zCArchiver* CreateArchiverWrite(zFILE* fileWrite, zTArchiveMode arcMode, zBOOL saveGame = FALSE, int arcFlags = 0)              zCall(0x0051AFA0);
    virtual zCArchiver* CreateArchiverWrite(const zSTRING& fileNameWrite, zTArchiveMode arcMode, zBOOL saveGame = FALSE, int arcFlags = 0)  zCall(0x0051AF20);
